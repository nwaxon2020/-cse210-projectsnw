...
class Program
{
    static void Main(string[] args)
    {
        ...
        Comment vid1Comment2 = new Comment("Prince Nwachukwu","I am not a fan of this type of Film but it great");
        Comment vid1Comment3 = new Comment("Mike Johnson","I don't like this movie");
